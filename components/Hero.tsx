    ...
    <section className="relative min-h-[45vh] sm:min-h-[70vh] flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 py-12 pt-24">
        ...
        >
          ...
          <Link
            href="/contact"
            className="flex-1 px-6 py-3 sm:px-10 sm:py-5 h-12 sm:h-auto border-2 border-premium-black text-premium-black font-bold uppercase tracking-wider rounded-none hover:bg-premium-black hover:text-white transition-all text-sm sm:text-lg text-center flex items-center justify-center"
          >
            Contact
          </Link>
        </motion.div>
